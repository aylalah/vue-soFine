...
<template>
  ...
  <!-- Full Page Intro -->
   ...
   <div class="card">
            ...
            <h6 class=" ">List Of Categories Type</h6>
            <!-- <h3>
                  ...
                  <div class="card-body px-lg-5">
                      ...
                      <form v-on:submit.prevent="addtype" class="text-center secondary">
                          ...
                          <div class="md-form mt-3">
                              <input v-model="type_name" type="text" id="materialSubscriptionFormName" class="form-control">
                              <label for="materialSubscriptionFormEmail">Type_name</label>
                          </div>
